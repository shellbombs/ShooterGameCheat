...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04AF1950;
	constexpr int32 AppendString      = 0x01115C20;
	constexpr int32 GNames            = 0x04AB5600;
	constexpr int32 GWorld            = 0x04C39D20;
	constexpr int32 ProcessEvent      = 0x01305360;
